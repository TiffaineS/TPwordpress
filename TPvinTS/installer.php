...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'tiffaineSetiaoVin_14c22494112f5fc34915_20230208111341_archive.zip';
        const ARCHIVE_SIZE       = '74386503';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '14c2249-08111341';
        const SECONDARY_PACKAGE_HASH = 'ce09ef2-08111341';
