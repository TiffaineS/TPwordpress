...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'tiffaineSetiaoVoyage_8e2fb0abe5e184427391_20230206124719_archive.zip';
        const ARCHIVE_SIZE       = '40754949';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '8e2fb0a-06124719';
        const SECONDARY_PACKAGE_HASH = 'ebd010b-06124719';
